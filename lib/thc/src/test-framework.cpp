...
bool regenerate_h_file()
{
    ...
    const char* hdr_files[] = {"../src/ChessDefs.h",        "../src/Move.h",
                               "../src/ChessPositionRaw.h", "../src/ChessPosition.h",
                               "../src/ChessRules.h",       "../src/ChessEvaluation.h"};
...
bool regenerate_cpp_file()
{
    ...
    const char* cpp_files[] = {"../src/Portability.cpp", "../src/PrivateChessDefs.h",
                               "../src/HashLookup.h",    "../src/ChessPosition.cpp",
                               "../src/ChessRules.cpp",  "../src/ChessEvaluation.cpp",
                               "../src/Move.cpp",        "../src/PrivateChessDefs.cpp"};
