...
class MoveSorter final
{
  ...
  private:
    ...
    static void quickSort(std::vector<thc::Move> &moves,std::vector<int> moveScores, int low, int high);
    static int partition(std::vector<thc::Move> &moves,std::vector<int> moveScores, int low, int high);
    static void swap(std::vector<thc::Move> &moves, std::vector<int> moveScores, int i, int j);
};
